...
namespace RoundsModcah.Cards
{
    class OverPowered : CustomCard
    {
        public override void SetupCard(CardInfo cardInfo, Gun gun, ApplyCardStats cardStats, CharacterStatModifiers statModifiers, Block block)
        {
            ...
            // +250% attack speed (lower value = faster firing, confirmed from earlier testing)
            gun.attackSpeed = 1f / 3.5f;
        ...
        {
            return "+10 Bullets, +250% Attack Speed, -50% Damage.";
        }
